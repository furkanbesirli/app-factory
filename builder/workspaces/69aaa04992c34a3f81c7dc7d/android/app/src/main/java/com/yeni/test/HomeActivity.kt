...
import com.yeni.test.review.ReviewBottomSheet
import com.yeni.test.review.ReviewGate
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            try {
                ...
                botOnlyMode = false
                loadWebView("https://yeni app.com")
            }
        }
    }
    ...
    override fun onBackPressed() {
        if (webView.canGoBack()) {
            ...
            AlertDialog.Builder(this)
                .setTitle("Exit Yeni App")
                .setMessage("Are you sure you want to close Yeni App?")
