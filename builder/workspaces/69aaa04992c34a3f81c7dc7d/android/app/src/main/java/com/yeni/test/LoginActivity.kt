...
import com.yeni.test.services.AdminService
import com.yeni.test.services.GoogleSignInService
import com.yeni.test.services.LocationService
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun getDefaultDocumentContent(docType: String): String {
        ...
        return when (docType) {
            "privacy" -> """YENI APP PRIVACY POLICY
            
Last Updated: $currentDate

1. INTRODUCTION
Welcome to Yeni App. We are committed to protecting your personal information and your right to privacy. This policy outlines how we handle your data when you use our mobile application.
...
Contact: legal@yeni appapp.com"""
            
            "terms" -> """YENI APP TERMS OF SERVICE

Last Updated: $currentDate

1. AGREEMENT TO TERMS
These Terms of Service constitute a legally binding agreement made between you and Yeni App. By accessing the app, you agree that you have read, understood, and agreed to be bound by all of these Terms.

2. ELIGIBILITY
You must be at least 18 years of age to use Yeni App. By using the app, you represent and warrant that you are of legal age and have the right, authority, and capacity to enter into this agreement.
...
Yeni App reserves the right to monitor interactions and remove any user who violates our safety standards or community guidelines without prior notice.

5. LIMITATION OF LIABILITY
Yeni App provides its services on an "as is" and "as available" basis. We do not guarantee that the service will always be safe, secure, or error-free.
...
1. THE YENI APP MISSION
Yeni App is built on the foundation of human connection. We strive to create a safe, respectful, and fun environment for everyone to meet new people.
...
Help us keep Yeni App safe for everyone!"""
...
Yeni App uses local storage and cookies to improve your experience and keep the app functional.
...
Questions? Contact: support@yeni appapp.com"""
    ...
    private fun showUpdateDialog(playStoreUrl: String) {
        androidx.appcompat.app.AlertDialog.Builder(this)
            ...
            .setMessage("A new version of Yeni App is available. Please update to continue.")
            .setCancelable(false)
