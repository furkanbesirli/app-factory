...
import com.sena.mobile.review.ReviewBottomSheet
import com.sena.mobile.review.ReviewGate
import com.sena.mobile.services.AdminService
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onBackPressed() {
        if (webView.canGoBack()) {
            ...
            AlertDialog.Builder(this)
                .setTitle("Exit Umingle")
                .setMessage("Are you sure you want to close Umingle?")
