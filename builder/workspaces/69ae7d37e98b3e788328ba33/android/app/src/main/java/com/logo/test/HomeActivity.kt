...
import com.logo.test.review.ReviewBottomSheet
import com.logo.test.review.ReviewGate
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onBackPressed() {
        if (webView.canGoBack()) {
            ...
            AlertDialog.Builder(this)
                .setTitle("Exit logo")
                .setMessage("Are you sure you want to close logo?")
