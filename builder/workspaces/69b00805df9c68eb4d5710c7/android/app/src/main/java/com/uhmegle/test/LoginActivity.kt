...
import com.uhmegle.test.services.AdminService
import com.uhmegle.test.services.GoogleSignInService
import com.uhmegle.test.services.LocationService
...
class LoginActivity : AppCompatActivity() {
    ...
    private var btnDiscover: MaterialButton? = null
    ...
    private lateinit var sidebarItemPrivacy: View
    private lateinit var sidebarItemTerms: View
    private lateinit var sidebarItemCommunity: View
    private lateinit var sidebarItemCookies: View
    private lateinit var sidebarItemSafety: View
    private var sidebarItemHowItWorks: View? = null
    private var sidebarItemBlog: View? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnDiscover = findViewById<MaterialButton?>(R.id.btnDiscover)
        ...
        sidebarItemHowItWorks = findViewById(R.id.sidebarItemHowItWorks)
        sidebarItemBlog = findViewById(R.id.sidebarItemBlog)
        ...
        sidebarItemHowItWorks?.setOnClickListener {
            closeSidebar()
            val intent = Intent(this, ExploreActivity::class.java)
            startActivity(intent)
        }

        sidebarItemBlog?.setOnClickListener {
            closeSidebar()
    ...
    private fun getDefaultDocumentContent(docType: String): String {
        ...
        return when (docType) {
            "privacy" -> """UHMEGLEE PRIVACY POLICY
            
Last Updated: $currentDate

1. INTRODUCTION
Welcome to Uhmeglee. We are committed to protecting your personal information and your right to privacy. This policy outlines how we handle your data when you use our mobile application.
...
Contact: legal@uhmegleeapp.com"""
            
            "terms" -> """UHMEGLEE TERMS OF SERVICE

Last Updated: $currentDate

1. AGREEMENT TO TERMS
These Terms of Service constitute a legally binding agreement made between you and Uhmeglee. By accessing the app, you agree that you have read, understood, and agreed to be bound by all of these Terms.

2. ELIGIBILITY
You must be at least 18 years of age to use Uhmeglee. By using the app, you represent and warrant that you are of legal age and have the right, authority, and capacity to enter into this agreement.
...
Uhmeglee reserves the right to monitor interactions and remove any user who violates our safety standards or community guidelines without prior notice.

5. LIMITATION OF LIABILITY
Uhmeglee provides its services on an "as is" and "as available" basis. We do not guarantee that the service will always be safe, secure, or error-free.
...
1. THE UHMEGLEE MISSION
Uhmeglee is built on the foundation of human connection. We strive to create a safe, respectful, and fun environment for everyone to meet new people.
...
Help us keep Uhmeglee safe for everyone!"""
...
Uhmeglee uses local storage and cookies to improve your experience and keep the app functional.
...
Questions? Contact: support@uhmegleeapp.com"""
    ...
    private fun showUpdateDialog(playStoreUrl: String) {
        androidx.appcompat.app.AlertDialog.Builder(this)
            ...
            .setMessage("A new version of Uhmeglee is available. Please update to continue.")
            .setCancelable(false)
