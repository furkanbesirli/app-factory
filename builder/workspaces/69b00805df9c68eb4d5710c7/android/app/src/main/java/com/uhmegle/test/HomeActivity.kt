...
import com.uhmegle.test.review.ReviewBottomSheet
import com.uhmegle.test.review.ReviewGate
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            try {
                ...
                botOnlyMode = false
                loadWebView("https://uhmeglee.com")
            }
        }
    }
    ...
    override fun onBackPressed() {
        if (webView.canGoBack()) {
            ...
            AlertDialog.Builder(this)
                .setTitle("Exit Uhmeglee")
                .setMessage("Are you sure you want to close Uhmeglee?")
