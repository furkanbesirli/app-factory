...
import com.logoo.test.review.ReviewBottomSheet
import com.logoo.test.review.ReviewGate
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onBackPressed() {
        if (webView.canGoBack()) {
            ...
            AlertDialog.Builder(this)
                .setTitle("Exit logo2")
                .setMessage("Are you sure you want to close logo2?")
