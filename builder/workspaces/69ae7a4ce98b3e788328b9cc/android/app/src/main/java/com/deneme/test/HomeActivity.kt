...
import com.deneme.test.review.ReviewBottomSheet
import com.deneme.test.review.ReviewGate
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onBackPressed() {
        if (webView.canGoBack()) {
            ...
            AlertDialog.Builder(this)
                .setTitle("Exit deneme")
                .setMessage("Are you sure you want to close deneme?")
