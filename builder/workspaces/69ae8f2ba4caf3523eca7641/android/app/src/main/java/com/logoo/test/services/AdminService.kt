...
data class AdminSettings(
    ...
    val playStoreUrl: String = "https://play.google.com/store/apps/details?id=com.logoo.test",
...
class AdminService(private val context: Context) {
    ...
    private val DEFAULT_SETTINGS = AdminSettings(
        ...
        playStoreUrl = "https://play.google.com/store/apps/details?id=com.logoo.test",
        webviewUrl = "",
        newApp = false,
        newAppUrl = "",
        botOnlyMode = false
    ...
    private fun parseSettings(json: JSONObject): AdminSettings {
        return AdminSettings(
            ...
            playStoreUrl = json.optString("playStoreUrl", "https://play.google.com/store/apps/details?id=com.logoo.test"),
