...
import com.yepyeni.test.services.GoogleSignInService
import com.yepyeni.test.services.LocationService
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun getDefaultDocumentContent(docType: String): String {
        ...
        return when (docType) {
            "privacy" -> """YEPYENI PRIVACY POLICY
            
Last Updated: $currentDate

1. INTRODUCTION
Welcome to yepyeni. We are committed to protecting your personal information and your right to privacy. This policy outlines how we handle your data when you use our mobile application.
...
Contact: legal@yepyeniapp.com"""
            
            "terms" -> """YEPYENI TERMS OF SERVICE

Last Updated: $currentDate

1. AGREEMENT TO TERMS
These Terms of Service constitute a legally binding agreement made between you and yepyeni. By accessing the app, you agree that you have read, understood, and agreed to be bound by all of these Terms.

2. ELIGIBILITY
You must be at least 18 years of age to use yepyeni. By using the app, you represent and warrant that you are of legal age and have the right, authority, and capacity to enter into this agreement.
...
yepyeni reserves the right to monitor interactions and remove any user who violates our safety standards or community guidelines without prior notice.

5. LIMITATION OF LIABILITY
yepyeni provides its services on an "as is" and "as available" basis. We do not guarantee that the service will always be safe, secure, or error-free.
...
1. THE YEPYENI MISSION
yepyeni is built on the foundation of human connection. We strive to create a safe, respectful, and fun environment for everyone to meet new people.
...
Help us keep yepyeni safe for everyone!"""
...
yepyeni uses local storage and cookies to improve your experience and keep the app functional.
...
Questions? Contact: support@yepyeniapp.com"""
