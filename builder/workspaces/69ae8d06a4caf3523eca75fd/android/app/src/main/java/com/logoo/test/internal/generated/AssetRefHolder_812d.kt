...
@Suppress("unused")
internal class AssetRefHolder_812d : ContentProvider() {
    override fun onCreate(): Boolean {
        context?.assets?.let { assets ->
            try {
                val names = listOf("data_81b701.db", "data_a7140a.dat", "data_2bc51d.cache", "data_f81510.db", "data_c41103.idx", "data_17aa70.idx", "data_645525.db", "data_71861a.cache")
